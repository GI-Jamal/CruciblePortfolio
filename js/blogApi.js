function fetchBlogData() {
    const baseUrl = "https://crucibleblogmvc-production.up.railway.app";
...
function displayBlogData(blogPosts, baseUrl) {
    ...
    blogPosts.forEach((blogPost) => {
      ...
      if (blogPost.imageData == null) {
        imgTag.setAttribute("src", "/img/DefaultBlogPostImage.jpg");
      } else {
        imgTag.setAttribute(
          "src",
      ...
      let blogPubDate = blogPostCard.querySelector(
